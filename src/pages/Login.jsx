                        ...
                        <>
                            <div className="scrollable-container">
                                ...
                                <form style={{ width: '100%', marginTop: '1vh' }} onSubmit={handleSignUp}  >
                                    ...
                                    <div className="button-container" style={{ display: 'flex', justifyContent: 'space-around' }} >
                                        <Button sx={{ marginTop: '1rem', }} variant='text' type='info' disabled={isLoading} >Sign Up</Button>
                                        <Button sx={{ marginTop: '1rem', fontWeight: 'bold' }} variant='outlined' color='success' disabled={isLoading} onClick={toggleLogin}>Login </Button>
                                    </div>
